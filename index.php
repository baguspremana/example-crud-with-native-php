...
<body>
	...
	<div class="w3-top" style="padding-top:62px">
		<div class="w3-bar w3-black w3-card-2">
			<a href="#" class="w3-bar-item w3-button w3-padding-large">Dasboard</a>
			<a href="login.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">Data Manipulation</a>
			<a href="#ourTeam" class="w3-bar-item w3-button w3-padding-large w3-hide-small">Our Team</a>
		</div>
	</div>

	<div id="navDemo" class="w3-bar-block w3-black w3-hide w3-hide-large w3-hide-medium w3-top" style="margin-top:46px">
		<a href="login.php" class="w3-bar-item w3-padding-large">Data Manipulation</a>
		<a href="#ourTeam" class="w3-bar-item w3-button w3-padding-large">Our Team</a>
	</div>

	<div class="w3-content" style="margin-top:70px;">
		
		<header class="w3-container w3-center" style="padding-top:55px">
			<h2 class="w3-wide"><b>Dasboard</b></h2>
		</header>
